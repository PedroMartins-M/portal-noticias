    ...
    @section("conteudo")
        ...
        <div>
            ...
            <p class="text-sm  text-slate-600">Fique por dentro das últimas novidades,
                tendências e acontecimentos mais recentes em um só lugar.</p>
        </div>
            ...
            @for ($i = 0; $i < 3; $i++)
                <article class="bg-white rounded-lg overflow-hidden shadow-sm">
                    ...
                    <div class="p-3">
                        ...
                        <p class="text-sm">
                            para desenvolvimento web de aplicações web em 2026.
                        </p>
